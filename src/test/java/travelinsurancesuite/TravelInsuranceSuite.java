...
public class TravelInsuranceSuite {
    ...
    public void startReport() throws IOException, InterruptedException {
        ...
        ReportName_with_path = "/test-output/travelInsurance"+reportRename+".html";
    ...
    public void aftersuite() throws IOException {
        ...
        GlobalVariables.TRAVEL_INSURANCE_REPORT_PATH = ReportName_with_path;

        customKeywords.replacingAllSuitesNamesValue("travelInsurance", ReportName_with_path);
